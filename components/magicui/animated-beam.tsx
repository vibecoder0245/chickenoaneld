...
export const AnimatedBeam: React.FC<AnimatedBeamProps> = ({
  ...
  delay = 0,
  pathColor = "gray", // Default to gray, can be themed
  pathWidth = 2,
  pathOpacity = 0.2,
  gradientStartColor = "hsl(var(--brand-cyan))", // Themed start
  gradientStopColor = "hsl(var(--brand-purple))", // Themed stop
  startXOffset = 0,
  startYOffset = 0,
  endXOffset = 0,
  endYOffset = 0,
  ...
  useEffect(() => {
    ...
    endXOffset,
    endYOffset,
    // Add dependencies that might change and require path recalculation
    gradientStartColor,
    gradientStopColor,
    pathColor,
  ])
    ...
    >
      ...
      <defs>
        <motion.linearGradient
          ...
          initial={{
            x1: "0%", // Adjusted for better initial state
            x2: "0%",
            y1: "0%",
            y2: "0%",
          }}
