...
export const LtcIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg fill="currentColor" viewBox="0 0 226.777 226.777" xmlns="http://www.w3.org/2000/svg" {...props}>
