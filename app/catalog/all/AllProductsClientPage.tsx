...
// Removed NewHeader import as it's likely in the root layout
      ...
      <main className="relative">
        ...
        <div className="relative container mx-auto mt-[70px] px-4 pb-20 pt-10 sm:pb-40">
          <div className="relative z-10 flex flex-col gap-4">
            ...
            {orderedCategoryKeys.map((categoryKey, sectionIndex) => {
              ...
              if (productsInCategory && productsInCategory.length > 0) {
                return (
                  <div key={categoryKey} className="flex flex-col gap-10 overflow-hidden pt-10">
                    <ScrollFadeIn delay={sectionIndex * 0.1}>
                    ...
                    <div className="grid grid-flow-row grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                      {productsInCategory.map((product, productIndex) => (
                        <ScrollFadeIn key={product.id} delay={sectionIndex * 0.1 + productIndex * 0.05}>
            ...
            {allProducts.length === 0 && (
              <ScrollFadeIn delay={orderedCategoryKeys.length * 0.1}>
